...
| Code | Status | When |
|---|---|---|
| `FEISHU_UPSTREAM_ERROR` | 502 | The code or token exchange with Feishu/Lark failed (transport error or an unusable reply). A rejection from Feishu is a `denied`, not this. |
